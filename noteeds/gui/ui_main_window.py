...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.viewLogAction = QAction(MainWindow)
        self.viewLogAction.setObjectName(u"viewLogAction")
        self.viewLogAction.setCheckable(True)
...
#endif // QT_CONFIG(shortcut)
        self.viewLogAction.setText(QCoreApplication.translate("MainWindow", u"&Log", None))
